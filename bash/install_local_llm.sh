...
REPO_NVIDIA_API_KEY="$(read_env_value "$REPO_ENV_FILE" NVIDIA_KIMI_K25_API_KEY || read_env_value "$REPO_ENV_FILE" FREEWILLER_NVIDIA_API_KEY || read_env_value "$REPO_ENV_FILE" NVIDIA_API_KEY || read_env_value "$REPO_ENV_FILE" NGC_API_KEY || true)"
...
NVIDIA_API_KEY="${NVIDIA_API_KEY:-${NVIDIA_KIMI_K25_API_KEY:-${FREEWILLER_NVIDIA_API_KEY:-$REPO_NVIDIA_API_KEY}}}"
