...
REPO_NVIDIA_API_KEY="$(read_env_value "$REPO_ENV_FILE" FREEWILLER_NVIDIA_API_KEY || read_env_value "$REPO_ENV_FILE" NVIDIA_API_KEY || read_env_value "$REPO_ENV_FILE" NGC_API_KEY || true)"
...
if [ -n "$REPO_NVIDIA_API_KEY" ] && [ -z "$FREEWILLER_CHEAP_API_KEY" ]; then
  FREEWILLER_CHEAP_PROVIDER_FAMILY="${FREEWILLER_CHEAP_PROVIDER_FAMILY:-nvidia}"
  FREEWILLER_CHEAP_API_BASE_URL="${FREEWILLER_CHEAP_API_BASE_URL:-$REPO_NVIDIA_API_BASE_URL}"
  FREEWILLER_CHEAP_API_KEY="$REPO_NVIDIA_API_KEY"
