...
FREEWILLER_CHEAP_API_BASE_URL="${FREEWILLER_CHEAP_API_BASE_URL:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_CHEAP_API_BASE_URL || true)}"
FREEWILLER_CHEAP_API_KEY="${FREEWILLER_CHEAP_API_KEY:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_CHEAP_API_KEY || true)}"
FREEWILLER_CHEAP_MODEL="${FREEWILLER_CHEAP_MODEL:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_CHEAP_MODEL || true)}"
FREEWILLER_CHEAP_API_MODE="${FREEWILLER_CHEAP_API_MODE:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_CHEAP_API_MODE || echo chat)}"
FREEWILLER_CHEAP_MAX_OUTPUT_TOKENS="${FREEWILLER_CHEAP_MAX_OUTPUT_TOKENS:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_CHEAP_MAX_OUTPUT_TOKENS || echo 1024)}"
...
FREEWILLER_PUBLIC_API_BASE_URL="${FREEWILLER_PUBLIC_API_BASE_URL:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_PUBLIC_API_BASE_URL || true)}"
FREEWILLER_PUBLIC_API_KEY="${FREEWILLER_PUBLIC_API_KEY:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_PUBLIC_API_KEY || true)}"
FREEWILLER_PUBLIC_MODEL="${FREEWILLER_PUBLIC_MODEL:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_PUBLIC_MODEL || true)}"
FREEWILLER_PUBLIC_API_MODE="${FREEWILLER_PUBLIC_API_MODE:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_PUBLIC_API_MODE || echo chat)}"
FREEWILLER_PUBLIC_MAX_OUTPUT_TOKENS="${FREEWILLER_PUBLIC_MAX_OUTPUT_TOKENS:-$(read_persisted_value "$PROVIDER_ROUTING_ENV_FILE" FREEWILLER_PUBLIC_MAX_OUTPUT_TOKENS || echo 1024)}"
